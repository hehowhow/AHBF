...
def craft_extract(extracted_text, craft_class, client):
    ...
    with open(r"C:\Users\howhow\PycharmProjects\AHBF\pdf_classify_and_extract\pdf_classify_and_extract\craft_schema/"+f"{craft_class}.json", "r",
              encoding="utf-8") as f:
...
def extract_single_pdf(pdf_path, folder_process_path, api_key):
    ...
    try:
        ...
        # if craft_rlt is not None:
        #     lines = craft_rlt.splitlines()
        #     if len(lines) > 2:
        #         craft_rlt = '\n'.join(lines[1:-1])
...
if __name__ == '__main__':
    ...
    api_key = "sk--WSmrkClgyH7wwB1QLvggg"
